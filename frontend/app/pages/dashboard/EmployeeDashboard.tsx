          ...
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 hover:text-blue-800 cursor-pointer" onClick={() => onViewDetail(1)}>View Detail</td>
              </tr>
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 hover:text-blue-800 cursor-pointer" onClick={() => onViewDetail(2)}>View Detail</td>
              </tr>
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 hover:text-blue-800 cursor-pointer" onClick={() => onViewDetail(3)}>View Detail</td>
              </tr>
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 hover:text-blue-800 cursor-pointer" onClick={() => onViewDetail(4)}>View Detail</td>
              </tr>
              <tr>
                ...
                <td className="px-6 py-4 whitespace-nowrap text-sm text-blue-600 hover:text-blue-800 cursor-pointer" onClick={() => onViewDetail(5)}>View Detail</td>
              </tr>
            </tbody>
          </table>
        </div>
...
function AppliedJobs({ onViewDetail }) {
  return (
    <div className="h-full">
          ...
          <form className="space-y-8">
            ...
            {activeTab === "personal" && (
              <div className="space-y-8">
                  ...
                  <div className="flex flex-col md:flex-row gap-8">
                    <div className="flex-1">
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center h-64 flex flex-col justify-center items-center">
                        ...
                        <label htmlFor="profile-upload" className="mt-4 inline-block px-5 py-3 bg-blue-600 text-white text-base font-medium rounded-md hover:bg-blue-700 cursor-pointer">
                          Browse File
                    ...
                    <div className="flex-1">
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center h-64 flex flex-col justify-center items-center">
                        ...
                        <p className="text-base text-gray-600 mb-2">Upload Cover Photo or Drag it here</p>
                        <p className="text-sm text-gray-500">Max File size 2 MB</p>
                        <label htmlFor="cover-upload" className="mt-4 inline-block px-5 py-3 bg-blue-600 text-white text-base font-medium rounded-md hover:bg-blue-700 cursor-pointer">
                          Browse File
                ...
                <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                  ...
                  <div>
                    <label htmlFor="professionalTitle" className="block text-base font-medium text-gray-700 mb-2">Professional Title</label>
                    <input 
                      type="text" 
                  ...
                  <div>
                    <label htmlFor="industry" className="block text-base font-medium text-gray-700 mb-2">Industry</label>
                    <select 
                      id="industry" 
                  ...
                  <div>
                    <label htmlFor="experienceLevel" className="block text-base font-medium text-gray-700 mb-2">Experience Level</label>
                    <select 
                      id="experienceLevel" 
            ...
            {activeTab === "professional" && (
              <div className="space-y-8">
                ...
                <div>
                  <label htmlFor="bio" className="block text-base font-medium text-gray-700 mb-2">Professional Summary</label>
                  <textarea 
                    id="bio" 
                    rows={8}
                    value={formData.bio}
            ...
            {activeTab === "social" && (
              <div className="space-y-8">
                ...
                <div className="space-y-6">
                  <div>
                    <label htmlFor="linkedin" className="block text-base font-medium text-gray-700 mb-2">LinkedIn</label>
                    <input 
                      type="url" 
                      id="linkedin" 
                  ...
                  <div>
                    <label htmlFor="github" className="block text-base font-medium text-gray-700 mb-2">GitHub</label>
                    <input 
                      type="url" 
                      id="github" 
                  ...
                  <div>
                    <label htmlFor="portfolio" className="block text-base font-medium text-gray-700 mb-2">Portfolio Website</label>
                    <input 
                      type="url" 
                      id="portfolio" 
