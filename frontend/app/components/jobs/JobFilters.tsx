...
export function JobFilters({ onFiltersChange, className = "" }: JobFiltersProps) {
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <div className="space-y-2">
            {['Near Me', 'Remote Job', 'Exact Location', 'Within 15 Km', 'Within 30 Km', 'Within 50 Km'].map((option) => (
        ...
        <div>
          ...
          {/* Salary Range */}
          <div className="space-y-2">
            {['Any', '> 30000k', '> 50000k', '> 80000k', '> 100000k'].map((range) => (
        ...
        {/* Date of Posting */}
        <div>
          <h4 className="text-sm font-medium text-gray-700 mb-3">Date of posting</h4>
          <div className="space-y-2">
            {['All Time', 'Last 24 Hours', 'Last 3 Days', 'Last 7 Days'].map((option) => (
              <label key={option} className="flex items-center">
                <input
                  type="radio"
                  name="datePosted"
        ...
        {/* Type of Employment */}
        <div>
          <h4 className="text-sm font-medium text-gray-700 mb-3">Type of employment</h4>
          <div className="space-y-2">
