...
export function JobCard({
  ...
  return (
    <div className={`bg-white rounded-xl border border-gray-200 p-6 hover:shadow-lg transition-all duration-200 relative ${className} min-w-[300px]`}>
      <div className="flex items-center justify-between">
        ...
        <h3 className="pl-2 text-[16px] font-[500] text-primary-text">{company}</h3>
      {/* Location */}
    ...
    <div className="flex items-center justify-start">
      ...
      <div className="mb-4 ">
        <span className={`px-3 py-1 rounded-xs text-xs font-medium ${getTypeColor(type)}`}>
          {type.toUpperCase()}
        </span>
      </div>
